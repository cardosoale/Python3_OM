...
response = requests.get('http://localhost:3333/', timeout=10)
...
# Adicionando "encoding" no BeautifulSoup 4 para evitar problemas com
# caracteres.
...
# Caso queira mudar a codificação de caracteres, envie os bytes diretamente
# para o BeautifulSoup e passe o valor da codificação de caracteres no atributo
...
# top_jobs_heading = parsed_html.select_one('#intro > div > div > article
# > h2')
