...
# arquivos de configuração para armazenar e acessar as suas variáveis de
# ambiente de forma mais fácil e segura em seus projetos.

# As variáveis de ambiente são valores que podem ser usados em seu código e
# que podem variar dependendo do ambiente em que o seu código está sendo
# executado (por exemplo, o ambiente de produção ou o ambiente de
# desenvolvimento).
...
# Em seu código, você pode acessar essas variáveis usando o módulo os e a
# função os.getenv(), por exemplo:
...
# nos commits. Crie um .env-example para exemplificar como usar o seu programa
#   com valores fictícios.

# Além disso, o python-dotenv também permite que você use um arquivo .env para
# armazenar valores de configuração específicos de cada ambiente, o que pode
# ser útil quando você estiver trabalhando em um projeto com diferentes
