...
# No exercício anterior, fizemos a soma de duas listas usando
# várias soluções diferentes.

# Uma delas foi usando zip para unir duas listas e utilizar
# list comprehension para fazer a conta:
